  ...
  const [projects, setProjects] = useState<Project[]>([
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: 't36', title: 'Phase 4: Alert emails (SendGrid)', completed: false, dueDate: '2026-03-10' },
        { id: 't37', title: 'Phase 4: GitHub Actions alerts', completed: false, dueDate: '2026-03-10' },
        { id: 't38', title: 'Phase 5: Vercel deployment', completed: false, dueDate: '2026-03-12' },
        { id: 't39', title: 'Phase 5: Production testing', completed: false, dueDate: '2026-03-15' },
      ],
      team: ['You', 'Johnny'],
      lastUpdated: '2026-03-05 07:20',
      nextAction: 'Phase 4: Add email alerts with SendGrid',
      priority: 'high',
      aiAssistant: 'Johnny'
    }
  ])
