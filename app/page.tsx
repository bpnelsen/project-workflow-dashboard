...
export default function Dashboard() {
  ...
  const [projects, setProjects] = useState<Project[]>([
    ...
    },
    {
      ...
      description: 'AI-powered financial platform for tracking 10-20 home builders with 10-K & earnings summaries',
      status: 'in-progress',
      progress: 30,
      tasks: [
        { id: 't32', title: 'Phase 1: Database & APIs', completed: true, dueDate: '2026-03-05' },
        { id: 't33', title: 'Phase 1: Stock price scraper', completed: true, dueDate: '2026-03-05' },
        { id: 't34', title: 'Phase 2: Claude AI wrapper', completed: true, dueDate: '2026-03-05' },
        { id: 't35', title: 'Phase 2: 10-K summarization', completed: false, dueDate: '2026-03-12' },
        { id: 't36', title: 'Phase 2: Earnings call analysis', completed: false, dueDate: '2026-03-12' },
        { id: 't37', title: 'Phase 3: Frontend (Next.js)', completed: false, dueDate: '2026-03-24' },
        { id: 't38', title: 'Phase 4: Automation & alerts', completed: false, dueDate: '2026-03-27' },
        { id: 't39', title: 'Phase 5: Deploy to Vercel', completed: false, dueDate: '2026-03-30' },
      ],
      team: ['You', 'Johnny'],
      lastUpdated: '2026-03-05 07:10',
      nextAction: 'Complete Phase 2 Claude integration, then Phase 3 Frontend',
      priority: 'high',
      aiAssistant: 'Johnny'
    }
  ])
