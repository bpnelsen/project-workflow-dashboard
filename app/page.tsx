  ...
  const [projects, setProjects] = useState<Project[]>([
    ...
    },
    {
      ...
      tasks: [
        ...
        { id: 't35', title: 'Phase 2: 10-K & earnings processing', completed: true, dueDate: '2026-03-05' },
        { id: 't36', title: 'Phase 2: GitHub Actions automation', completed: true, dueDate: '2026-03-05' },
        { id: 't37', title: 'Phase 3: Frontend (Next.js)', completed: false, dueDate: '2026-03-24' },
        { id: 't38', title: 'Phase 4: Alerts & email', completed: false, dueDate: '2026-03-27' },
        { id: 't39', title: 'Phase 5: Deploy to Vercel MVP', completed: false, dueDate: '2026-03-30' },
      ],
      team: ['You', 'Johnny'],
      lastUpdated: '2026-03-05 07:15',
      nextAction: 'Phase 3: Build frontend pages (6 key pages)',
      priority: 'high',
      aiAssistant: 'Johnny'
    }
  ])
